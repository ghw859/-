            ...
            <div
              ...
              <div
                ...
                <div class="w-full h-full bg-white rounded-full flex items-center justify-center relative shadow-inner">
                  ...
                  <i
                    class="fa-solid fa-eye text-3xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-600 to-emerald-400"></i>
                </div>
                <div
      ...
      <div
        ...
        <div class="flex items-center space-x-3.5 relative z-10">
          <div
            ...
            <i class="fa-solid fa-server text-lg text-white"></i>
          ...
          <div class="flex flex-col">
            ...
            <span class="text-[9px] text-cyan-600 font-extrabold tracking-wider uppercase -mt-0.5">AI驱动的智能银行办理平台</span>
          </div>
        </div>
        ...
        <div class="space-y-6 relative z-10">
          <div class="space-y-2">
            ...
            <h2 class="text-2xl font-black tracking-tight text-slate-800">客户安全登录认证</h2>
            <p class="text-xs text-slate-500">ICBC · 灵枢多模态安全链路运行正常，请验证您的身份。</p>
          </div>

          <form class="space-y-[18px]" @submit.prevent="handleLogin">
            <div class="space-y-1.5">
              <label class="text-xs font-bold text-slate-600 tracking-wide">工行账号 / 手机号</label>
              <div class="relative">
                <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400 text-sm">
                  <i class="fa-regular fa-id-badge"></i>
                </span>
                <input v-model="username" type="text" required placeholder="请输入工行账号或手机号"
            ...
            <div class="space-y-1.5">
              <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-cyan-600 hover:text-cyan-700 font-medium transition-colors">忘记密码</a>
              </div>
              <div class="relative">
                <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400 text-sm">
                  <i class="fa-solid fa-fingerprint"></i>
                </span>
                <input v-model="password" type="password" required placeholder="请输入登录密码"
                  class="w-full bg-white/60 border border-slate-200/80 focus:border-cyan-500 focus:bg-white/90 rounded-xl pl-11 pr-4 py-2.5 text-sm text-slate-800 outline-none transition-all focus:ring-4 focus:ring-cyan-500/10 backdrop-blur-md placeholder:text-slate-400">
              </div>
            </div>
